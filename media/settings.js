...
(function (root) {
  ...
  const ROWS = [
    ...
    },
    {
      ...
      description: "Automatically attach screen snapshots taken with Ctrl+Alt+S / Cmd+Alt+S directly to the chat composer as an image chip.",
      kind: "toggle",
      defaultValue: true,
    ...
    },
    {
      ...
      description: "Custom hard disk folder path where screen snapshots are saved on Windows / macOS. Leave empty to use default system temp.",
      kind: "folder",
      defaultValue: "",
